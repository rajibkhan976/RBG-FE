...
export const RESET_CREATE_DOCUMENT_CATEGORY_RESPONSE =
	"RESET_CREATE_DOCUMENT_CATEGORY_RESPONSE";
export const RESET_UPDATE_DOCUMENT_CATEGORY_RESPONSE =
	"RESET_UPDATE_DOCUMENT_CATEGORY_RESPONSE";
export const RESET_DELETE_DOCUMENT_CATEGORY_RESPONSE =
	"RESET_DELETE_DOCUMENT_CATEGORY_RESPONSE";
export const CREATE_CONTRACT_DOCUMENT = "CREATE_CONTRACT_DOCUMENT";
export const RESET_CREATE_CONTRACT_DOCUMENT_RESPONSE =
	"RESET_CREATE_CONTRACT_DOCUMENT_RESPONSE";
...
export const RESET_DELETE_CONTRACT_DOCUMENT_RESPONSE =
	"RESET_DELETE_CONTRACT_DOCUMENT_RESPONSE";
export const FETCH_CONTRACT_DOCUMENT = "FETCH_CONTRACT_DOCUMENT";
export const UPDATE_CONTRACT_DOCUMENT = "UPDATE_CONTRACT_DOCUMENT";
export const RESET_UPDATE_CONTRACT_DOCUMENT_RESPONSE =
	"RESET_UPDATE_CONTRACT_DOCUMENT_RESPONSE";
export const SIGN_CONTRACT_DOCUMENT = "SIGN_CONTRACT_DOCUMENT";
export const RESET_SIGN_CONTRACT_DOCUMENT_RESPONSE =
	"RESET_SIGN_CONTRACT_DOCUMENT_RESPONSE";
export const FETCH_CONTRACT_DOCUMENTS_BY_CONTACTID =
	"FETCH_CONTRACT_DOCUMENTS_BY_CONTACTID";
export const FETCH_CONTRACT_DOCUMENT_BY_CONTACTID_CONTRACTID =
	"FETCH_CONTRACT_DOCUMENT_BY_CONTACTID_CONTRACTID";

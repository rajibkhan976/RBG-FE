                                                        ...
                                                        <div className='iconType'  onClick={() => openContactModal(elem)}>
                                                            <div
                                                                className=
                                                                {
																	...
																	elem?.log_type === "CALL" ? 
                                                                        (elem?.direction === "outbound" ? "roundIconBase call outbound" : 
                                                                            (elem?.direction === "inbound" ?
                                                                                (elem?.data?.status === "forwarded" ? "roundIconBase call forwarded" :
                                                                                    (elem?.data?.callStatus === ("no-answer" || "ringing") ? "roundIconBase call misscall" : "roundIconBase call inbound")
                                                                                )
                                                                             : "")
                                                                        )
                                                                        : ""
                                                                ...
                                                                <img src={
																	...
																	elem?.log_type === "CALL" ? 
                                                                        (elem?.direction === "outbound" ? outgoing_Call : 
                                                                            (elem?.direction === "inbound" ?
                                                                                (elem?.data?.status === "forwarded" ? callForword :
                                                                                    (elem?.data?.callStatus === ("no-answer" || "ringing") ? missedcall : incoming_Call)
                                                                                )
                                                                             : "")
                                                                        )
                                                                        : ""

	...
	return (
          ...
          <span className="searchIco">
            ...
            >
              <g transform="translate(-1.5 -1.5)">
				...
				>
					<img
						src={setupModalStatus ? SettingIconBlue : SettingIcon}
						alt=''
					/>
				</button>
          ...
          <img src={PlusIconFill} />
				...
				>
					<img
						...
						alt=''
					/>
					{notificationStructure.totalNotification > 0 ? (
						<span>{notificationStructure.totalNotification}</span>
					) : (
						""
					)}
				</button>
        ...
        {locationLoaded === "automation" && (
          ...
          >
			...
			{stateUserMenu && (
				<div
					className='sideMenuOuter headeruserMenu'
					style={{ zIndex: zIndexUser }}
				>
					<div
						className='dialogBg'
						onClick={toggleUserMenu}
                  ...
                  backgroundImage: `url(${loggedInUser && loggedInUser.image ? loggedInUser.image : userPhoto})`
								...
								<div className='user_profile'>
									<img
										src={loggedInUser.image ? loggedInUser.image : userPhoto}
										alt='avatar'
										style={{
											height: "100%",
										}}
								...
								<div className='userContacts'>
									...
									{loggedInUser && loggedInUser.isEdit ? (
										<div className='userPhone'>
											<img
												src={editIcon_white}
												alt=''
						...
						<div className='user_modal_body'>
							<div className='user_modal_cont'>
								...
								{loggedInUser && loggedInUser.isShowPlan ? (
									<div className='creditText'>
										<span>Credit Balance </span>
										{loggedInUser.isOrganizationOwner && loggedInUser.credit ? (
											<span
												className='blue cr_balance'
												onClick={redirectToCreditLogs}
											>
									...
									loggedInUser.isShowPlan && loggedInUser.isPackage ? (
										<div className='userPlan cr_userPlan'>
											...
											<div className='cr_userPlanRight'>
												<button onClick={redirectToPackagePurchase}>
													Buy Credits
												</button>
											</div>
										</div>
							...
							<div className='user_modal_menu'>
								...
								<p>
									<NavLink
										...
										target='_blank'
										className='privacyLink termsLink'
									>
										Terms &amp; Conditions
									</NavLink>
								</p>
			...
			{modalMakeEmail && <EmailModal emailModalOff={emailModalOffhandler} />}
		</>
	);
}

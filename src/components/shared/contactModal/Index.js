...
const ContactModal = () => {
    ...
    const closeContactModal = () => {
        setContactModalOpenStatus(false);
    }

    const formScroll = (formScrollStatus) => {
        setStickeyHeadStatus(formScrollStatus);
        console.log(formScrollStatus)
    };
 
    return(
        <>
        { contactModalOpenStatus ? 
        <div className="modal contactModal">
            <div className="modalContainer">
                    ...
                    <div className="contactModalHeaderTopSec">
                        ...
                        <div className="modalCtrl">
                            ...
                            <button className="closeModal">
                                <img src={cross_white} alt="" onClick={closeContactModal} />
                            </button>
                        </div>
                ...
                <div className="tabBarArea">
                    <Steps config={config}>
                        <Step title="Overview" component={Overview} formScroll={(formScrollStatus) => formScroll(formScrollStatus)} />

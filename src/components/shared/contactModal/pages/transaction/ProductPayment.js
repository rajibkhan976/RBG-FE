  ...
  return (
    <>
      <form className="productPaymentTransaction">
        ...
        <div className="gridCol">
          <div class="cartProductInner payOverviewProduct">
          ...
          <div class="cartProductInner outstandingOverviewProduct">
            <header className="informHeader d-flex f-align-center f-justify-between">
              <h5>Outstanding</h5>
              <h3>$ 420.00</h3>
            </header>
          ...
          <div className="totalCartValue cartProductInner f-row">
            ...
            <div className="buyBtns">
              <button class="saveNnewBtn" onClick={(e) => billPayment(e)}>

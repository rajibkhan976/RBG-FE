...
const Overview = (props) => {
	...
	const getContact = async (contactId) => {
		...
		try {
			if (contactId !== 0) {
				...
				let contact = await ContactService.fetchContact(
				...
				setBasicinfoPhone({
					countryCode: contact.contact.phone
						? contact.contact.phone.countryCode
							? contact.contact.phone.countryCode
							: "US"
						: "US",
					dailCode: contact.contact.phone
						? contact.contact.phone.dailCode
							? contact.contact.phone.dailCode
							: "+1"
						: "+1",
					number: contact.contact.phone
						? contact.contact.phone.number
							...
							: ""
						: "",
					full_number: contact.contact.phone
						? contact.contact.phone.full_number
							? contact.contact.phone.full_number
							: ""
						: "",
					original_number: contact.contact.phone
						? contact.contact.phone.original_number
							? contact.contact.phone.original_number
							: ""
						: "",
					location: contact.contact.phone
						? contact.contact.phone.location
							? contact.contact.phone.location
							: "None"
						: "None",
					country: contact.contact.phone
						? contact.contact.phone.country
							? contact.contact.phone.country
							: ""
						: "",
					carrier: contact.contact.phone
						? contact.contact.phone.carrier
							? contact.contact.phone.carrier
							: "None"
						: "None",
					timezone: contact.contact.phone
						? contact.contact.phone.timezone
							? contact.contact.phone.timezone
							: "America/New_York"
						: "America/New_York",
					is_valid: contact.contact.phone
						? contact.contact.phone.is_valid
							? contact.contact.phone.is_valid
							: false
						: false,
				});
				setBasicinfoMobilePhone({
					countryCode: contact.contact.mobile
						? contact.contact.mobile.countryCode
							? contact.contact.mobile.countryCode
							: "US"
						: "US",
					dailCode: contact.contact.mobile
						? contact.contact.mobile.dailCode
							? contact.contact.mobile.dailCode
							: "+1"
						: "+1",
					number: contact.contact.mobile
						? contact.contact.mobile.number
							? contact.contact.mobile.number
							: ""
						: "",
					full_number: contact.contact.mobile
						? contact.contact.mobile.full_number
							? contact.contact.mobile.full_number
							: ""
						: "",
					original_number: contact.contact.mobile
						? contact.contact.mobile.original_number
							? contact.contact.mobile.original_number
							: ""
						: "",
					location: contact.contact.mobile
						? contact.contact.mobile.location
							? contact.contact.mobile.location
							: "None"
						: "None",
					country: contact.contact.mobile
						? contact.contact.mobile.country
							? contact.contact.mobile.country
							: ""
						: "",
					carrier: contact.contact.mobile
						? contact.contact.mobile.carrier
							? contact.contact.mobile.carrier
							: "None"
						: "None",
					timezone: contact.contact.mobile
						? contact.contact.mobile.timezone
							? contact.contact.mobile.timezone
							: "America/New_York"
						: "America/New_York",
					is_valid: contact.contact.mobile
						? contact.contact.mobile.is_valid
							? contact.contact.mobile.is_valid
							: false
						: false,
				});
				setBasicinfoMomPhone({
					countryCode: contact.contact.momPhone
						? contact.contact.momPhone.countryCode
							? contact.contact.momPhone.countryCode
							: "US"
						: "US",
					dailCode: contact.contact.momPhone
						? contact.contact.momPhone.dailCode
							? contact.contact.momPhone.dailCode
							: "+1"
						: "+1",
					number: contact.contact.momPhone
						? contact.contact.momPhone.number
							? contact.contact.momPhone.number
							: ""
						: "",
					full_number: contact.contact.momPhone
						? contact.contact.momPhone.full_number
							? contact.contact.momPhone.full_number
							: ""
						: "",
					original_number: contact.contact.original_number
						? contact.contact.momPhone.original_number
							? contact.contact.momPhone.original_number
							: ""
						: "",
					location: contact.contact.momPhone
						? contact.contact.momPhone.location
							? contact.contact.momPhone.location
							: "None"
						: "None",
					country: contact.contact.momPhone
						? contact.contact.momPhone.country
							? contact.contact.momPhone.country
							: ""
						: "",
					carrier: contact.contact.momPhone
						? contact.contact.momPhone.carrier
							? contact.contact.momPhone.carrier
							: "None"
						: "None",
					timezone: contact.contact.momPhone
						? contact.contact.momPhone.timezone
							? contact.contact.momPhone.timezone
							: "America/New_York"
						: "America/New_York",
					is_valid: contact.contact.momPhone
						? contact.contact.momPhone.is_valid
							? contact.contact.momPhone.is_valid
							: false
						: false,
				});
				setBasicinfoDadPhone({
					countryCode: contact.contact.dadPhone
						? contact.contact.dadPhone.countryCode
							? contact.contact.dadPhone.countryCode
							: "US"
						: "US",
					dailCode: contact.contact.dadPhone
						? contact.contact.dadPhone.dailCode
							? contact.contact.dadPhone.dailCode
							: "+1"
						: "+1",
					number: contact.contact.dadPhone
						? contact.contact.dadPhone.number
							? contact.contact.dadPhone.number
							: ""
						: "",
					full_number: contact.contact.dadPhone
						? contact.contact.dadPhone.full_number
							? contact.contact.dadPhone.full_number
							: ""
						: "",
					original_number: contact.contact.dadPhone
						? contact.contact.dadPhone.original_number
							? contact.contact.dadPhone.original_number
							: ""
						: "",
					location: contact.contact.dadPhone
						? contact.contact.dadPhone.location
							? contact.contact.dadPhone.location
							: "None"
						: "None",
					country: contact.contact.dadPhone
						? contact.contact.dadPhone.country
							? contact.contact.dadPhone.country
							: ""
						: "",
					carrier: contact.contact.dadPhone
						? contact.contact.dadPhone.carrier
							? contact.contact.dadPhone.carrier
							: "None"
						: "None",
					timezone: contact.contact.dadPhone
						? contact.contact.dadPhone.timezone
							? contact.contact.dadPhone.timezone
							: "America/New_York"
						: "America/New_York",
					is_valid: contact.contact.dadPhone
						? contact.contact.dadPhone.is_valid
							? contact.contact.dadPhone.is_valid
							: false
						: false,
				});
	...
	const handelBasicinfoMobilePhone = (event) => {
		...
		if (name === "number") {
			...
			if (!pattern.test(event.target.value)) {
				...
				setBasicinfoMobilePhone((prevState) => ({
					...prevState,
					full_number: basicinfoMobilePhone.dailCode + value,
				}));
				setBasicinfoMobilePhone((prevState) => ({
					...prevState,
					original_number:
						basicinfoMobilePhone.dailCode.replace("+", "") + value,
				}));
			}
		}
	};
		...
		if (name === "number") {
			...
			if (!pattern.test(event.target.value)) {
				...
				setBasicinfoPhone((prevState) => ({
					...prevState,
					full_number: basicinfoPhone.dailCode + value,
				}));
				setBasicinfoPhone((prevState) => ({
					...prevState,
	...
	const handelBasicinfoMomPhone = (event) => {
		...
		if (name === "countryCode") {
			...
			let dailCode =
				daileCodeindex !== undefined
					? daileCodeindex.getAttribute("data-dailcode")
					: "+1";
			setBasicinfoMomPhone((prevState) => ({
				...prevState,
				dailCode: dailCode,
			}));
			setBasicinfoMomPhone((prevState) => ({
		...
		if (name === "number") {
			...
			if (!pattern.test(event.target.value)) {
				...
				setBasicinfoMomPhone((prevState) => ({
					...prevState,
					full_number: basicinfoMomPhone.dailCode + value,
				}));
				setBasicinfoMomPhone((prevState) => ({
					...prevState,
					original_number: basicinfoMomPhone.dailCode.replace("+", "") + value,
				}));
			}
		}
	};
	...
	const handelBasicinfoDadPhone = (event) => {
		...
		if (name === "countryCode") {
			...
			let dailCode =
				daileCodeindex !== undefined
					? daileCodeindex.getAttribute("data-dailcode")
					: "+1";
			setBasicinfoDadPhone((prevState) => ({
				...prevState,
				dailCode: dailCode,
			}));
			setBasicinfoDadPhone((prevState) => ({
		...
		if (name === "number") {
			...
			if (!pattern.test(event.target.value)) {
				...
				setBasicinfoDadPhone((prevState) => ({
					...prevState,
					full_number: basicinfoDadPnone.dailCode + value,
				}));
				setBasicinfoDadPhone((prevState) => ({
					...prevState,
					original_number: basicinfoDadPnone.dailCode.replace("+", "") + value,
				}));
			}
		}
	};
	...
	const onContactSubmit = async (e) => {
		...
		if (
			...
			if (basicinfoEmail) {
				...
				if (
					!basicinfoEmail &&
					(basicinfoPhone.number === "" || !pattern.test(basicinfoPhone.number))
				) {
					isError = true;
		...
		if (isError) {
			...
			try {
				let updateContact = await ContactService.updateContact(
					newPayload,
					contactIdNew
				);
				if (updateContact) {
			...
			case "momPhone":
				if (basicinfoMomPhone.number) {
					...
					if (result.success) {
						...
						setFormErrorMsg((prevState) => ({
							...prevState,
							momPhone: result.message,
						}));
					}
				} else {
					setFormErrorMsg((prevState) => ({
						...prevState,
						momPhone: "Number not given.",
					}));
				}
				break;
			case "dadPhone":
				if (basicinfoDadPnone.number) {
					...
					if (result.success) {
						...
						setFormErrorMsg((prevState) => ({
							...prevState,
							dadPhone: result.message,
						}));
					}
				} else {
					setFormErrorMsg((prevState) => ({
						...prevState,
						dadPhone: "Number not given.",
					}));
				}
				break;
			default:
	...
	const handlePhaseChange = (event) => {
		...
		if (event.target.value) {
			let searchResultPhases = phases.find(
	...
	return (
		<div
			className={
				formScrollStatus ? "contactModalTab expanded" : "contactModalTab"
			}
			id='scrollDiv'
			onScroll={formScroll}
		>
				...
				<form>
					<div className='overviewFormWrap overviewInfos'>
						<div className='overviewForm cmnForm'>
								...
								<div className='cmnFormCol'>
									...
									>
										<input
											...
											defaultValue={basicinfoFname}
											placeholder=''
											onChange={handelBasicinfoFname}
										/>
										{formErrorMsg.fName ? (
											<p className='errorMsg'>{formErrorMsg.fName}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									...
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoLname}
											onChange={handelBasicinfoLname}
										/>
										{formErrorMsg.lName ? (
											<p className='errorMsg'>{formErrorMsg.lName}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Date of Birth</div>
									<div
										className={
											formErrorMsg.dob
												? "cmnFormField errorField"
									...
									>
										<DatePicker
											className='cmnFieldStyle'
											selected={
												basicinfoDob ? new Date(basicinfoDob + " 00:00:00") : ""
											}
											format='MM/dd/yyyy'
										...
										/>
										{formErrorMsg.dob ? (
											<p className='errorMsg'>{formErrorMsg.dob}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									...
									>
										<input
											type='email'
											className='cmnFieldStyle'
											placeholder='Eg. Jon.doe@domain.com'
											value={basicinfoEmail}
											onChange={handelBasicinfoEmail}
										/>
										{formErrorMsg.email ? (
											<p className='errorMsg'>{formErrorMsg.email}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									...
									<div
										className={
											formErrorMsg.phone
												? "cmnFormField countryCodeField phoneNumberField errorField"
												: "cmnFormField phoneNumberField countryCodeField"
										}
									>
										<div className='countryCode cmnFieldStyle'>
											<div className='countryName'>
												{basicinfoPhone.countryCode}
											</div>
										...
										<input
											...
											value={basicinfoPhone.number}
											onChange={handelBasicinfoPhone}
										/>
										<button
											className='verifyNumberButton'
										...
										{formErrorMsg.phone ? (
											<p className='errorMsg'>{formErrorMsg.phone}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Mobile</div>
									<div
										className={
											formErrorMsg.mobile
												? "cmnFormField countryCodeField phoneNumberField errorField"
									...
									>
										...
										<input
											...
											name='number'
											placeholder='Eg. (555) 555-1234'
											value={basicinfoMobilePhone.number}
											onChange={handelBasicinfoMobilePhone}
										/>
										<button
											className='verifyNumberButton'
											onClick={(e) => verifyNumber(e, "mobile")}
										>
											<img
												src={verify_icon}
												alt=''
										...
										{formErrorMsg.mobile ? (
											<p className='errorMsg'>{formErrorMsg.mobile}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Phase</div>
									<div
										className={
											formErrorMsg.phase
												? "cmnFormField errorField"
									...
									>
										...
										{formErrorMsg.phase ? (
											<p className='errorMsg'>{formErrorMsg.phase}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Status</div>
									<div
										className={
											formErrorMsg.status
												? "cmnFormField errorField"
									...
									>
										...
										{formErrorMsg.status ? (
											<p className='errorMsg'>{formErrorMsg.status}</p>
										) : (
											""
										)}
									</div>
						...
						<div className='overviewForm cmnForm'>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Company</div>
									<div
										className={
											formErrorMsg.company
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoCompany}
											onChange={handelBasicinfoCompany}
										/>
										{formErrorMsg.company ? (
											<p className='errorMsg'>{formErrorMsg.company}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Job Role</div>
									<div
										className={
											formErrorMsg.jobRole
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoJobRole}
											onChange={handelBasicinfoJobRole}
										/>
										{formErrorMsg.jobRole ? (
											<p className='errorMsg'>{formErrorMsg.jobRole}</p>
										) : (
											""
										)}
									</div>
						...
						<div className='overviewForm cmnForm'>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Mother's Name</div>
									<div
										className={
											formErrorMsg.momName
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoMomName}
											onChange={handelBasicinfoMomName}
										/>
										{formErrorMsg.momName ? (
											<p className='errorMsg'>{formErrorMsg.momName}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Mother's Phone Number</div>
									<div
										className={
											formErrorMsg.momPhone
												? "cmnFormField countryCodeField phoneNumberField errorField"
												: "cmnFormField phoneNumberField countryCodeField"
										}
									>
										<div className='countryCode cmnFieldStyle'>
											<div className='countryName'>
												{basicinfoMomPhone.countryCode}
											</div>
											<div className='daileCode'>
												{basicinfoMomPhone.dailCode}
											</div>
											<select
												className='selectCountry'
												name='countryCode'
										...
										<input
											...
											name='number'
											placeholder='Eg. (555) 555-1234'
											defaultValue={basicinfoMomPhone.number}
											onChange={handelBasicinfoMomPhone}
										/>
										<button
											className='verifyNumberButton'
											onClick={(e) => verifyNumber(e, "momPhone")}
										>
											<img
												src={verify_icon}
												alt=''
										...
										{formErrorMsg.momPhone ? (
											<p className='errorMsg'>{formErrorMsg.momPhone}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Father's Name</div>
									<div
										className={
											formErrorMsg.dadName
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoDadName}
											onChange={handelBasicinfoDadName}
										/>
										{formErrorMsg.dadName ? (
											<p className='errorMsg'>{formErrorMsg.dadName}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Father's Phone Number</div>
									<div
										className={
											formErrorMsg.dadPhone
												? "cmnFormField countryCodeField phoneNumberField errorField"
												: "cmnFormField phoneNumberField countryCodeField"
										}
									>
										<div className='countryCode cmnFieldStyle'>
											<div className='countryName'>
												{basicinfoDadPnone.countryCode}
											</div>
											<div className='daileCode'>
												{basicinfoDadPnone.dailCode}
											</div>
											<select
												className='selectCountry'
												name='countryCode'
										...
										<input
											...
											name='number'
											placeholder='Eg. (555) 555-1234'
											defaultValue={basicinfoDadPnone.number}
											onChange={handelBasicinfoDadPhone}
										/>
										<button
											className='verifyNumberButton'
											onClick={(e) => verifyNumber(e, "dadPhone")}
										>
											<img
												src={verify_icon}
												alt=''
										...
										{formErrorMsg.dadPhone ? (
											<p className='errorMsg'>{formErrorMsg.dadPhone}</p>
										) : (
											""
										)}
									</div>
						...
						<div className='overviewForm cmnForm'>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Address 1</div>
									<div
										className={
											formErrorMsg.address1
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<textarea
											...
											onChange={handelBasicinfoAddress1}
										></textarea>
										{formErrorMsg.address1 ? (
											<p className='errorMsg'>{formErrorMsg.address1}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Address 2</div>
									<div
										className={
											formErrorMsg.address2
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<textarea
											...
											onChange={handelBasicinfoAddress2}
										></textarea>
										{formErrorMsg.address2 ? (
											<p className='errorMsg'>{formErrorMsg.address2}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>City</div>
									<div
										className={
											formErrorMsg.city
												? "cmnFormField errorField"
									...
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoCity}
											onChange={handelBasicinfoCity}
										/>
										{formErrorMsg.city ? (
											<p className='errorMsg'>{formErrorMsg.city}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>State</div>
									<div
										className={
											formErrorMsg.state
												? "cmnFormField errorField"
									...
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoState}
											onChange={handelBasicinfoState}
										/>
										{formErrorMsg.state ? (
											<p className='errorMsg'>{formErrorMsg.state}</p>
										) : (
											""
										)}
									</div>
							...
							<div className='cmnFormRow'>
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Zip</div>
									<div
										className={
											formErrorMsg.zip
												? "cmnFormField errorField"
									...
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoZip}
											onChange={handelBasicinfoZip}
										/>
										{formErrorMsg.zip ? (
											<p className='errorMsg'>{formErrorMsg.zip}</p>
										) : (
											""
										)}
									</div>
								...
								<div className='cmnFormCol'>
									<div className='cmnFieldName'>Country</div>
									<div
										className={
											formErrorMsg.country
												? "cmnFormField errorField"
												: "cmnFormField"
										}
									>
										<input
											...
											className='cmnFieldStyle'
											placeholder=''
											defaultValue={basicinfoCountry}
											onChange={handelBasicinfoCountry}
										/>
										{formErrorMsg.country ? (
											<p className='errorMsg'>{formErrorMsg.country}</p>
										) : (
											""
										)}
									</div>
						...
						<div className='overviewForm cmnForm'>
							{customFields.length > 0 && (
								<>
									...
									{customFields.map((row, index) => (
										<div
											className='cmnFormRow'
											key={index}
										>
											{row.map((col, index2) => (
												<div
													className='cmnFormCol'
													key={index2}
												>
													<div className='cmnFieldName'>{col.fieldName}</div>
													<div
														className={
															formErrorMsg.zip
																? "cmnFormField errorField"
																...
																case "text":
																	return (
																		<input
																			...
																			pattern={col.fieldRegex}
																			defaultValue={
																				contact ? contact[col.alias] : ""
																			}
							...
							<div className='cmnFormRow'>
								<div className='formActBtnWrap'>
									<button
										className='saveNnewBtn saveOverview'
										type='button'
										onClick={(e) => onContactSubmit(e)}
									>
										{" "}
										{props.contactId === 0 ? "Save" : "Update"}{" "}
										<img
											src={arrow_forward}
											alt=''
										/>
									...
									<button
										className='btn-link'
										onClick={props.closeContactModal}
									>
										Cancel
									</button>
								</div>

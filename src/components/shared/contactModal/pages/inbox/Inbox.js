...
const Inbox = (props) => {
  ...
  const emailplaceholdingData = (data) => {
    ...
    console.log("Before conversion", yyyy + "-" + mm + "-" + dd + " " + time);
    let emailUtcToTimezoneConversion = utils.convertUTCToTimezone(yyyy + "-" + mm + "-" + dd + " " + time, timezoneOffset);
    console.log("After conversion", emailUtcToTimezoneConversion);
    ...
    setnewEmailData(current => [
      {
        ...
        // date: emailUtcToTimezoneConversion
      }
      , ...current])
  ...
  const smsPlaceholdingData = (data) => {
    ...
    console.log("Before conversion", yyyy + "-" + mm + "-" + dd + " " + time);
    let smsUtcToTimezoneConversion = utils.convertUTCToTimezone(yyyy + "-" + mm + "-" + dd + " " + time, timezoneOffset);
    console.log("After conversion", smsUtcToTimezoneConversion);
    const keys = Object.keys(contactGenData);
    let body = data.body;
    ...
    setnewEmailData(current => [
      ...
      , ...current])
      // console.log("sms place holdeing data", newEmailData);
    comLogRef.current.scrollTop = comLogRef.current.scrollHeight - comLogRef.current.clientHeight
  }
              ...
              return (
               ...
               ""
                    ...
                    <div className="info">
                      ...
                      {/* <span>With out convert {moment(elem?.updated_at).format('YYYY-MM-DD hh:mm:ss')}</span> */}
                      <span><img src={smalCalendar} />{utils.convertUTCToTimezone(moment(elem?.updated_at), timezoneOffset)}</span>
                    </div>
                  </div>
                </div>
              )
              ...
              return (
                <div className="inboxChat outgoingChat" key={key}>
                  ...
                  <div className="txtArea">
                    ...
                    <div className="info">
                      {/* <span><img src={smallPh}/>({elem.from}) SMS NUMBER.</span> */}
                      {/* <span><img src={smalCalendar} />with out convert{elem.date}</span> */}
                      <span><img src={smalCalendar} />{utils.convertUTCToTimezone(elem?.date,timezoneOffset)}</span>
                    </div>

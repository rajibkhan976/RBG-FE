...
const OpenPanel = (props) => {
	...
	const editSmsHandler = (e) => {
		if (
			...
			!loggedInUser.isPackage &&
			(!loggedInUser.credit || loggedInUser.credit < 1)
		) {
			dispatch({
			...
			dispatch({
				...
				message:
					"There is no active package found. Please contact your gym owner",
				typeMessage: "error",
			});
		} else if (loggedInUser.credit && loggedInUser.credit > 0) {
			setCallPanel(false);
			setEmailPanel(false);
			setSmsPanel(true);
		}
		...
		<>
			<div className='editingPanel'>
				<div className='editPanelHeader'>
					...
					<button
						className={smsPanel ? "outLinedBtn active" : "outLinedBtn"}
						onClick={editSmsHandler}
						disabled={
							(contactGenData?.phone?.full_number || "") === "" ||
							("status" in device && device.status()) != "ready"
								? "disabled"
								: ""
						}
					>
						...
						>
							...
							/>
							<path
								d='M14 17.5C16.7614 17.5 19 15.2614 19 12.5C19 9.73858 16.7614 7.5 14 7.5C11.2386 7.5 9 9.73858 9 12.5C9 15.2614 11.2386 17.5 14 17.5Z'
								stroke='none'
								stroke-width='1.2'
								stroke-miterlimit='10'
								stroke-linejoin='round'
							/>
							<path
								d='M14.1484 14.717L16.3054 12.63L14.1484 10.543'
								stroke='none'
								stroke-width='1.2'
								stroke-miterlimit='10'
								stroke-linejoin='round'
							/>
							<path
								d='M15.609 8.248V1.5H1V16.109C3.44289 14.1223 6.2929 12.6973 9.348 11.935'
								stroke='none'
								stroke-width='1.2'
								stroke-miterlimit='10'
								stroke-linejoin='round'
					...
					<button
						className={callPanel ? "outLinedBtn active" : "outLinedBtn"}
						onClick={editCallHandler}
						disabled={("status" in device && device.status()) != "ready"}
					>
						<svg
							width='18'
							height='18'
           ...
           >
            ...
            Email
					...
					<button
						className={emailPanel ? "outLinedBtn active" : "outLinedBtn"}
					...
					>
						...
						>
							<path
								d='M9.39948 14.4143H1.14648V1.44531H18.8325V7.34531'
								stroke='none'
								stroke-width='1.2'
								stroke-linejoin='round'
							/>
							<path
								d='M1.14648 1.44531L9.98948 7.93031L18.8325 1.44531'
								stroke='none'
								stroke-width='1.2'
								stroke-linejoin='round'
							/>
							<path
								d='M15.2949 9.10938L17.6529 11.4674L15.2949 13.8254'
								stroke='none'
								stroke-width='1.2'
								stroke-linejoin='round'
							/>
							<path
								d='M17.3207 11.457H11.9297'
								stroke='none'
								stroke-width='1.2'
								stroke-linejoin='round'
							/>

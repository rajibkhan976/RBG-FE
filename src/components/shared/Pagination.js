  ...
  return (
    <>
      ...
      <div className="paginationOuter">
        <ul>
          <li>
            <button className="btn paginationBtn" onClick={preClickHandle} disabled={props.paginationData.currentPage === 1}>
          ...
          {pageIncrementBtn}
          <li>
            <button className="btn paginationBtn" onClick={nextClickHandle} disabled={props.paginationData.currentPage === props.paginationData.totalPages}>
              <svg

...
import docBuilderIcon from "../../../assets/images/doc_builder_icon.svg";
...
const Setup = (props) => {
	...
	return (
		<>
			<div
				className='setUpPopUp'
				style={{ zIndex: zIndexSetting }}
			>
				<Scrollbars
							...
							<div className='listHead'>
								<i>
									...
									>
										...
										/>
										<path
											d='M28 26H0V28H28V26Z'
											fill='#305671'
										/>
										<path
											d='M2 28L2 0L0 0L0 28H2Z'
											fill='#305671'
										/>
										<path
											d='M28 28V0L26 0V28H28Z'
											fill='#305671'
										/>
										<path
											d='M15 18L15 0L13 0L13 18H15Z'
											fill='#305671'
										/>
										<path
											d='M26 16H2V18H26V16Z'
											fill='#305671'
										/>
									</svg>
								</i>

		...
		<>
			...
			<div className='dashboardElComponent'>
				...
				<div className='dashInnerStructure'>
					<Switch>
						<Route
							path='/customizations/custom-fields'
							component={Customizations}
						/>
						<Route
							path='/customizations/appointment-tags'
							component={AppointmentTags}
						/>
						<Route
							path='/customizations/program-age-groups'
							component={ProgramAgeGroup}
						/>
						<Route
							path='/customizations/product-sizes'
							component={ProductSizes}
						/>
						<Route
							path='/customizations/product-color'
							component={ProductColors}
						/>
						<Route
							exact
							path='/customizations'
							component={() => <Redirect to='/customizations/custom-fields' />}
						/>
					</Switch>
					<DashboardFooter />
				</div>

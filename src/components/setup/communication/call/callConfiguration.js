...
const CallConfiguration = (props) => {
  ...
  const handleCheck = (val, list) => {
    let exists = false;
    list.some((el) => {
      if (el.day.includes(val)) exists = true;
    });
    return exists;
  };
  ...
  const scheduleOverite = async () => {
    for (let i = 0; i < schedule.length; i++) {
      if (!schedule[i].startTimeNumber) {
        schedule[i].startTimeNumber = convertTimeToNumber(
  ...
  const validateForm = async () => {
    ...
    for (var si = 0; si < schedule.length; si++) {
      ...
      if (!schedule[si].day.length || stTime >= endTime) {
        isOkay = false;
        schedule[si].error =
          "Please select at least a day and time 'To' must be greater than 'From'";
      } else {
        schedule[si].error = "";
      }
    }
        ...
        <div className="sideMenuBody">
          <form className="formBody">
            ...
            <div className="scheduleList">
                ...
                return (
                  <div className="cmnFormRow scheduleRow" key={key}>
                    <div className="cmnFormCol">
                      ...
                      <div className="cmnFormField d-flex">
                    ...
                    <div className="cmnFormCol">
                      ...
                      >
                        ...
                        <div className="cmnFormCol d-flex">
                          <div className="cmnFormField">
                    ...
                    {schedule[key].error && (
                      <div className="cmnFormRow">
                        <span className="formMsg errorMsg error">
                          {schedule[key].error}
                        </span>
                      </div>
                    )}
              ...
              {isOverlapped && (
                <div className="slotNotAbailable">
                  <p>
                    ...
                    more configuration. Do you want to remove the same time from
                  ...
                  <div className="btnGroup">
                    ...
                    <button
                      className="cmnBtn btn-red"
                      onClick={() => setIsOverlapped(false)}
                    >
                      No
                    </button>
                  </div>
              ...
              {overlappValidated && (
                <div className="formMsg success" style={{
                  fontSize: "12px"
                }}>
                  Schedule slot(s) is validated
                </div>
              )}

              {scheduleErr && (
                <div className="formMsg errorMsg error">
                  <p>{scheduleErr}</p>
                </div>
              )}
            </div>
                    ...
                    <div className="setupFormRowBody">
                      <div className="cmnFormRow">
                        <div className="cmnFormField">
                          ...
                          <div
                            className={
                              "toggleBtn " + (instCallForward ? "active" : "")
                            }
                          >
                            <input
                              type="checkbox"
                              defaultChecked={instCallForward}
                              onChange={(e) =>
                                handleCheckboxChange(e, "InstCallForward")
                              }
                            />
                            ...
                            <div className="cmnFormField countryCodeField">
                              <div className="countryCode cmnFieldStyle">
                                <div className="countryName">
                                  {newCallForwardPrefix.split("_")[0]}
                                </div>
                                <div className="daileCode">
                                  +{newCallForwardPrefix.split("_")[1]}
                                </div>
                                <select
                                  className="selectCountry"
                                  onChange={(e) =>
                                    handleInputChange(e, "NewCallForwardPrefix")
                                  }
                                >
                                    ...
                                    <div className="numberListAction">
                                      <div className="info_3dot_icon">
                                        <button
                                          className="btn"
                                          onClick={(e) =>
                                            handleCallForwardOption(e, pIndex)
                                          }
                                        >
                                          <img
                                            src={info_3dot_icon}
                                      ...
                                      <div
                                        className={
                                          (callForwardOption === pIndex
                                            ? " listShow "
                                            : " listHide ") + " dropdownOptions"
                                        }
                                      >
                                        <button
                                          className="btn btnDelete"
                                          onClick={(e) =>
                                            removeCallForwardNumber(e, pIndex)
                                          }
                                        >
                                          <span>
                                            <svg

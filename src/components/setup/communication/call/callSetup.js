...
const CallSetup = () => {
  ...
  const uploadRingtone = async () => {
    ...
    if (
      !fileUploadStatus ||
      (fileUploadStatus == undefined && choosedFilePath !== "")
    ) {
      setRingtoneLoader(true);
  ...
  const statusToogle = async (ev, id, key) => {
    try {
      configurationList[key].status =
        configurationList[key].status == "active" ? "inactive" : "active";
      setConfigurationList([...configurationList]);
      setIsLoader(true);
    ...
    <div className="dashInnerUI">
      ...
      <div className="userListHead">
        <div className="listInfo">
          ...
          <p className="userListAbout">Setup call related all configurations</p>
        </div>
          ...
          <div className="assignedNumberArea">
            ...
            <p>
              {"+" +
                numberObj.prefix +
                "-" +
                numberObj.nationalNumber +
                " [ " +
                numberObj.numberAlias +
                " ] "}
            </p>
                  ...
                  <li key={key}>
                    ...
                    <div>
                      <ul className="weekDateList">
                        <li
                          className={
                            handleCheck("sun", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("mon", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("tue", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("wed", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("thu", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("fri", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >
                        ...
                        <li
                          className={
                            handleCheck("sat", list.schedules)
                              ? "weekDate active"
                              : "weekDate"
                          }
                        >

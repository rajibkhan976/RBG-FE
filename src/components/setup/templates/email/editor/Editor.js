...
const EditorComponent = (props) => {
	...
	let initialValue = props.initialData
		? props.initialData.template
		: "Type here...";
	...
	emailTemplate &&
		emailTemplate._id &&
		props.editorToPreview(payloadEditedData);
	...
	const editKeywordEmail = (e, field) => {
		...
		try {
			if (cursorStart || cursorStart == "0") {
				...
				subjectEditInput.value =
					subjectEditInput.value + " [" + e.target.textContent + "] ";
	...
	const editKeywordTextEmail = (e, field) => {
		...
		let iframeEditBody = (
			iframeEdit.contentDocument || iframeEdit.contentWindow.document
		).body;
		...
		<>
			{props.createNew ? (
				<>
					<div
						className={
							max ? "editorEmailShell h-100 maximize" : "editorEmailShell h-100"
						}
						id='createTextArea'
						ref={createTextArea}
					>
						...
						<div className='createEmailButtons'>
							...
							>
								{max ? (
									...
									>
										<path
											d='M3.40014 6.99964H1V3.40014C1 2.76358 1.25287 2.1531 1.70299 1.70299C2.1531 1.25287 2.76358 1 3.40014 1H6.99964V3.40014H3.40014V6.99964Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M24.9999 6.99964H22.5997V3.40014H19.0002V1H22.5997C23.2363 1 23.8468 1.25287 24.2969 1.70299C24.747 2.1531 24.9999 2.76358 24.9999 3.40014V6.99964Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M6.99964 25H3.40014C2.76358 25 2.1531 24.7471 1.70299 24.297C1.25287 23.8469 1 23.2364 1 22.5998V19.0003H3.40014V22.5998H6.99964V25Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M22.5997 25H19.0002V22.5998H22.5997V19.0003H24.9999V22.5998C24.9999 23.2364 24.747 23.8469 24.2969 24.297C23.8468 24.7471 23.2363 25 22.5997 25Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M16.3799 10.8206C16.1414 10.8225 15.9077 10.7531 15.7088 10.6215C15.5099 10.4898 15.3547 10.3018 15.2632 10.0815C15.1717 9.86124 15.1479 9.61866 15.1949 9.3848C15.242 9.15094 15.3577 8.93642 15.5273 8.76866L18.1477 6.14826C18.2597 6.03629 18.3926 5.94747 18.5389 5.88688C18.6852 5.82628 18.842 5.79509 19.0003 5.79509C19.1587 5.79509 19.3155 5.82628 19.4618 5.88688C19.608 5.94747 19.741 6.03629 19.8529 6.14826C19.9649 6.26023 20.0537 6.39315 20.1143 6.53945C20.1749 6.68574 20.2061 6.84254 20.2061 7.00088C20.2061 7.15923 20.1749 7.31603 20.1143 7.46232C20.0537 7.60862 19.9649 7.74154 19.8529 7.85351L17.2311 10.4725C17.1191 10.5837 16.9863 10.6717 16.8402 10.7314C16.6941 10.7911 16.5377 10.8215 16.3799 10.8206Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M18.782 10.889H15.1086V7.21562'
											stroke='#305671'
											stroke-width='1.5'
										...
										/>
										<path
											d='M15.1783 17.0123C15.1765 16.7738 15.2458 16.5401 15.3775 16.3412C15.5091 16.1423 15.6971 15.9871 15.9174 15.8956C16.1377 15.804 16.3803 15.7803 16.6141 15.8273C16.848 15.8744 17.0625 15.9901 17.2303 16.1597L19.8507 18.7801C19.9627 18.892 20.0515 19.025 20.1121 19.1713C20.1727 19.3176 20.2039 19.4743 20.2039 19.6327C20.2039 19.791 20.1727 19.9478 20.1121 20.0941C20.0515 20.2404 19.9627 20.3734 19.8507 20.4853C19.7387 20.5973 19.6058 20.6861 19.4595 20.7467C19.3132 20.8073 19.1564 20.8385 18.9981 20.8385C18.8397 20.8385 18.6829 20.8073 18.5366 20.7467C18.3903 20.6861 18.2574 20.5973 18.1454 20.4853L15.5265 17.8635C15.4153 17.7515 15.3273 17.6187 15.2675 17.4726C15.2078 17.3265 15.1775 17.1701 15.1783 17.0123Z'
											fill='#305671'
											stroke='#F6F8FA'
											stroke-width='0.3'
										/>
										<path
											d='M15.1093 19.4154V15.742H18.7827'
											stroke='#305671'
											stroke-width='1.5'
											stroke-linecap='round'
											stroke-linejoin='round'
						...
						<MergeTag
							addfeild={(e, field) => createKeywordTextEmail(e, field)}
						/>
						{max ? (
							<button
								className='cmnBtn'
				...
				<>
					...
					>
						...
						>
							...
							<MergeTag
								addfeild={(e, field) => editKeywordTextEmail(e, field)}
							/>

							{editHasError && editErrorState.message && (
								<span className='errorMsg'>
									Please give some Email content.
								</span>
							)}
						</div>
					</form>
					...
					>
						...
						>
							...
							<Editor
								...
								initialValue={
									props.setTempSelected &&
									utils.decodeHTML(emailTemplate.template)
								}
								init={{
									height: "100%",
									menubar: false,
							...
							<MergeTag
								addfeild={(e, field) => editKeywordSendEmail(e, field)}
							/>

...
export const CustomizationServices = {
    ...
    fetchTags: async () => {
        try {
            let url = config.appointmentTag + "list?pageId=all";
            const result = await axios.get(url, { headers: headers });
            return result.data;
        } catch (e) {
    ...
    createTag: async (payload) => {
        try {
            let url = config.appointmentTag;
            const result = await axios.post(url, payload, { headers: headers });
            if(result.status === 200) {
                return result.data;
            } else {
                throw new Error("There is an error on create tag. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    deleteTag: async (id) => {
        try {
            let url = config.appointmentTag + id;
            const result = await axios.delete(url, { headers: headers });
            if(result.status === 200) {
                return result.data;
            } else {
                throw new Error("There is an error on deleting tag. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    createAgeGroup: async (payload) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on create age group. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    editAgeGroup: async (payload, id) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on editing age group. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    deleteAgeGroup: async (id) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on deleting age group. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    createProductSize: async (payload) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on create product sizes. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    editProductSize: async (payload, id) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on editing product sizes. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    deleteProductSize: async (id) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on deleting product size. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
    ...
    createProductColor: async (payload) => {
        try {
            ...
            if(result.status === 200) {
                ...
                throw new Error("There is an error on create product colors. Please contact support");
            }
        } catch (e) {
            if(e.response && e.response.data && e.response.data.message) {
                console.log(e.response.data.message);
